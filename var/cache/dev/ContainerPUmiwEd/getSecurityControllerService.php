...
return $this->services['App\Controller\SecurityController'] = new \App\Controller\SecurityController(($this->services['security.csrf.token_manager'] ?? $this->load('getSecurity_Csrf_TokenManagerService.php')));
