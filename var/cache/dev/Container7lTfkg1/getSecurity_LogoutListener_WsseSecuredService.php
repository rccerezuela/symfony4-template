...
// Returns the private 'security.logout_listener.wsse_secured' shared service.
...
$this->privates['security.logout_listener.wsse_secured'] = $instance = new \Symfony\Component\Security\Http\Firewall\LogoutListener(($this->services['security.token_storage'] ?? $this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, 'admin_login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'admin_logout'));
