...
class srcDevDebugProjectContainer extends Container
{
    ...
    protected function getDebug_Security_FirewallService()
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.dev' => function () {
        ...
        }, 'security.firewall.map.context.wsse_secured' => function () {
            return ($this->privates['security.firewall.map.context.wsse_secured'] ?? $this->load('getSecurity_Firewall_Map_Context_WsseSecuredService.php'));
            ...
            yield 'security.firewall.map.context.wsse_secured' => ($this->privates['security.request_matcher.00qF1Z7'] ?? $this->privates['security.request_matcher.00qF1Z7'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'));
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('wsse_secured', 'admin_logout', 'logout', '_csrf_token', NULL, NULL);
