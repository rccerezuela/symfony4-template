...
// Returns the private 'security.authentication.provider.anonymous.wsse_secured' shared service.
...
return $this->privates['security.authentication.provider.anonymous.wsse_secured'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'));
